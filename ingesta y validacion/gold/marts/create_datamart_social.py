...
def create_inversion_vs_vulnerabilidad(
    ...
    datos = fact_vulnerabilidad_df.merge(
        fact_contratacion_df[['divipola_municipio', 'monto_contrato', 'fecha_publicacion_key']],
        on='divipola_municipio',
        how='left',
    )
    
    # Llenar nulos para evitar errores en agregación
    datos['monto_contrato'] = datos['monto_contrato'].fillna(0)
    datos['fecha_publicacion_key'] = datos['fecha_publicacion_key'].fillna(19000101)
    
    # Extraer año de fecha_key
    datos['anio'] = (datos['fecha_publicacion_key'] // 10000).astype(int)
    ...
    # Aplanar columnas dinámicamente
